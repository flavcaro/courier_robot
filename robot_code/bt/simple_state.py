...
class SimpleRobotState:
    def __init__(self):
        ...
        self.wall_following_rule = 'left'  # 'left' o 'right' - wall-following rule
        ...
        self.meters_per_second_forward = 0.044  # ~4.4cm/s (da calibrare!)
        self.meters_per_second_lateral = 0.044  # ~4.4cm/s laterale
        ...
        # === SENSORI ===
        self.obstacle_threshold = 15.0  # cm - Soglia sicurezza durante movimento (stop immediato)
        # Nota: Durante movimento controlla ogni 100ms, con inerzia serve margine extra
        self.obstacle_threshold_static = 30.0  # cm - Per scansioni statiche (più preciso)
        self.direction_clearance_threshold = 40.0  # cm - Spazio minimo per considerare direzione "libera"
        # ⚠️ IMPORTANTE: Step 50cm + 10cm margine sicurezza = minimo 40cm richiesto
        ...
        self.use_imu_heading_correction = True  # ✅ ABILITATO - Correzione CONTINUA deriva durante movimento
        self.imu_heading_correction_gain = 0.25  # ⬆️ AUMENTATO da 0.15 a 0.25 per correzione più aggressiva
        self.imu_heading_correction_debug = True  # Stampa messaggi quando corregge
        # Nota: correzione avviene ogni 100ms durante movimento, aggiustando velocità motori in tempo reale
        ...
        # === CALIBRAZIONE ODOMETRIA IMU ===
        self.imu_odometry_scale = 0.60  # Fattore correttivo: IMU sovrastima ~40%
